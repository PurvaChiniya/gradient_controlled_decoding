...
if __name__ == "__main__":
    ...
    import json
    import pandas as pd 
    df = pd.read_csv("./datasets/security_data.csv")
    for model_id in ['meta-llama/Llama-2-7b-chat-hf']:
        ...
        auprc, f1, predicted_labels, cos_all = cos_sim_xstest(model_id, df,gradient_norms_compare, minus_row_cos, minus_col_cos)
        df['predicted_label'] = predicted_labels
        df['cos_all'] = cos_all
        import pdb 
        pdb.set_trace()
        df.to_csv("gradSafe_security.csv")